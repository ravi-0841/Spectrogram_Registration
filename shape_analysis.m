...
for i = 1:32
    ...
    z3 = dict_nutrl(:,i);
    figure(1),...
        subplot(131),plotEllipticFourierDescriptor(z1(1:num_coeffs),z1(1+num_coeffs:2*num_coeffs),...
        z1(2*num_coeffs+1:3*num_coeffs),z1(3*num_coeffs+1:4*num_coeffs),500,1),...
        title('Sad'),subplot(132),...
        plotEllipticFourierDescriptor(z2(1:num_coeffs),z2(num_coeffs+1:2*num_coeffs),...
        z2(2*num_coeffs+1:3*num_coeffs),z2(3*num_coeffs+1:4*num_coeffs),500,1),...
        title('Happy'),subplot(133),...
        plotEllipticFourierDescriptor(z3(1:num_coeffs),z3(num_coeffs+1:2*num_coeffs),...
        z3(2*num_coeffs+1:3*num_coeffs),z3(3*num_coeffs+1:4*num_coeffs),500,1),title('Neutral');
    pause;
end
