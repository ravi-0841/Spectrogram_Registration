...
if __name__ == '__main__':  
    ...
    # INPUT:==============================================================================
    wav_file_orig = './JHU_emo/happy.wav' # Original natural waveform. You can choose any of the provided ones in the /wavs_nat directory.
    out_dir       = './JHU_emo' # Where the synthesised waveform will be stored
