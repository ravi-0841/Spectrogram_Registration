...
if isprop(ax, 'SortMethod')
  set(handles.sgramAxisA,'SortMethod','childorder');
else
...
if isprop(ax, 'SortMethod')
  set(handles.sgramAxisB,'SortMethod','childorder');
else
  set(handles.sgramAxisB,'drawmode','fast');
end;
...
ax = get(gca);
if isprop(ax, 'SortMethod')
  set(handles.distanceMatrixAxis,'SortMethod','childorder');
else
  set(handles.distanceMatrixAxis,'drawmode','fast');
end;
...
ax = get(gca);
if isprop(ax, 'SortMethod')
  set(handles.locator,'SortMethod','childorder');
else
  set(handles.locator,'drawmode','fast');
end;
