...
%% Get the wav file in
infile='angry.wav'; % please provide a test file
if useaudioread
...
tmp = stft(istft(abs(X),wshift,S),N,wshift,W)-X; % difference between temporary signal (zero phase) spectrogram and actual signal spectrogram 
